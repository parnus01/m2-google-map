/**
 *
 * Copyright © 2015 AcommercePippin. All rights reserved.
...
define([
    'jquery',
    'mage/template',
    'text!AcommercePippin_GoogleMap/templates/plugin.html',
    'jquery/ui',
    'domReady!'
], function ($, mageTemplate, pluginTemplate) {
    'use strict';

    $.widget('AcommercePippin.googleMapPagePlugin', {
    ...
    return $.AcommercePippin.googleMapPagePlugin;
});